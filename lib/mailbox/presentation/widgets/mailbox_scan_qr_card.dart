...
class MailboxScanQrCard extends StatelessWidget {
  final void Function(String address) onScanned;

  const MailboxScanQrCard({super.key, required this.onScanned});
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Text(
                'Scan a mailbox QR code to add it',
                style: theme.caption,
  ...
  void _openScanner(BuildContext context) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => _QrScannerScreen(onScanned: onScanned),
      ),
    );
  }
}
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: Text(
                      'Position mailbox QR code within the frame',
