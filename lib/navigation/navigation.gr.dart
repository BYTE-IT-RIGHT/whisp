...
class LocalAuthRouteArgs {
  ...
  @override
  String toString() {
    return 'LocalAuthRouteArgs{key: $key, initialAuthentication: $initialAuthentication}';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is! LocalAuthRouteArgs) return false;
    return key == other.key &&
        initialAuthentication == other.initialAuthentication;
  }

  @override
  int get hashCode => key.hashCode ^ initialAuthentication.hashCode;
}
