...
import 'package:whisp/conversations_library/domain/contact.dart' as _i10;
...
import 'package:whisp/messaging/domain/message.dart' as _i11;
import 'package:whisp/onboarding/presentation/onboarding_screen.dart' as _i6;
import 'package:whisp/tutorial/presentation/tutorial_screen.dart' as _i7;

/// generated route for
/// [_i1.AddContactScreen]
class AddContactRoute extends _i8.PageRouteInfo<void> {
  const AddContactRoute({List<_i8.PageRouteInfo>? children})
...
class AppStartupRoute extends _i8.PageRouteInfo<void> {
  const AppStartupRoute({List<_i8.PageRouteInfo>? children})
...
class ConversationsLibraryRoute extends _i8.PageRouteInfo<void> {
  const ConversationsLibraryRoute({List<_i8.PageRouteInfo>? children})
...
class InvitationRoute extends _i8.PageRouteInfo<InvitationRouteArgs> {
  InvitationRoute({
    _i9.Key? key,
    required _i11.Message invitation,
...
class TutorialRoute extends _i8.PageRouteInfo<void> {
  ...
  static _i8.PageInfo page = _i8.PageInfo(
    name,
    builder: (data) {
      return const _i7.TutorialScreen();
    },
  );
}
